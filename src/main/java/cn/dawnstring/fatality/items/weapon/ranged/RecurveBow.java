...
public class RecurveBow extends BaseWeapon
{
    private static final int COOLDOWN_TICKS = 10; // 冷却时间10tick（0.5秒）
    private static final float BASE_ARROW_DAMAGE = 12.0f; // 基础箭矢伤害
    ...
    public RecurveBow()
    {
        ...
        }, new Properties(), (int)BASE_ARROW_DAMAGE, 1.0f, 1f, 0.05f, 0.05f, 0.1f, WeaponEnum.RANGED);
    }
