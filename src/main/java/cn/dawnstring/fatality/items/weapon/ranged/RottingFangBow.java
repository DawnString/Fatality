...
/**
 * 腐化獠牙弓 - 高伤害快速远程武器
 * 特性：高基础伤害、快速攻击速度、中等暴击率
 */
public class RottingFangBow extends BaseWeapon
{
    private static final int COOLDOWN_TICKS = 10; // 冷却时间10tick（0.5秒）
    private static final float BASE_ARROW_DAMAGE = 38.0f; // 基础箭矢伤害38

    public RottingFangBow()
    {
        super(new Tier() {
            @Override
            public int getUses() {
        ...
        }, new Properties(), (int)BASE_ARROW_DAMAGE, 0.5f, 1f, 0.08f, 0.10f, 0.2f, WeaponEnum.RANGED);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide()) {
            ...
            arrow.shoot(lookVec.x, lookVec.y, lookVec.z, 4.0F, 0.8F); // 4.0速度，较小散布
            ...
            level.playSound(null, player.getX(), player.getY(), player.getZ(),
                    SoundEvents.ARROW_SHOOT, SoundSource.PLAYERS, 1.0F, 0.7F); // 更低的音调
        }
