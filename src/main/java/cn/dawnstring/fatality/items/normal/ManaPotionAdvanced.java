 ...
 */
public class ManaPotionAdvanced extends NormalItem {
    private static final int MANA_RESTORE_AMOUNT = 300; // 恢复300点魔法值
    private static final int MAGIC_FADE_DURATION = 300; // 15秒 * 20tick/秒 = 300tick

    public ManaPotionAdvanced() {
        super();
        this.setStory("高级魔力药水，可以立即恢复300点魔法值，但会暂时降低魔法伤害和恢复效果。");
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide()) {
            ...
            player.displayClientMessage(Component.literal("§a使用高级魔力药水！恢复300点魔法值，获得魔力衰减效果（15秒）"), true);
