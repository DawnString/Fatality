...
{
    private static final String ABILITY_ID = "glow_abyss_stone_reduction";
    private static final long COOLDOWN_DURATION = 60000;
    private static final float DAMAGE_REDUCTION_PERCENTAGE = 0.70f;
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        if (event.getEntity() instanceof Player player) {
            if (hasAccessoryEquipped(player, GlowAbyssStone.class)) {
