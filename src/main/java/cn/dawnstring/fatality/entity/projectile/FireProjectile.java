...
public class FireProjectile extends AbstractArrow {
    private static final EntityDataAccessor<Boolean> DATA_SHATTERED = SynchedEntityData.defineId(FireProjectile.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> DATA_DAMAGE = SynchedEntityData.defineId(FireProjectile.class, EntityDataSerializers.FLOAT);
    ...
    public FireProjectile(Level level, LivingEntity shooter, ItemStack weapon, float damage) {
        this(ModEntities.FIRE_PROJECTILE.get(), level);
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        if (compound.contains("FireDamage")) {
            this.entityData.set(DATA_DAMAGE, compound.getFloat("FireDamage"));
        }
    }
    ...
    public void addAdditionalSaveData(CompoundTag compound) {
        ...
        compound.putFloat("FireDamage", getFireDamage());
    }
}
