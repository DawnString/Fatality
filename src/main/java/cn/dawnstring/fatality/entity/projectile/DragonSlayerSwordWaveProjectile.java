...
/**
 * 屠龙大剑剑气投射物
 * 特性：竖着的红色粒子剑气，中等飞行速度，能够穿透敌人造成伤害
 */
public class DragonSlayerSwordWaveProjectile extends AbstractArrow {
    ...
    public DragonSlayerSwordWaveProjectile(EntityType<? extends DragonSlayerSwordWaveProjectile> type, Level level) {
        super(type, level);
    }
    
    public DragonSlayerSwordWaveProjectile(Level level, LivingEntity shooter, float swordWaveDamage) {
        super(ModEntities.DRAGON_SLAYER_SWORD_WAVE_PROJECTILE.get(), shooter, level);
    ...
    private void spawnHitParticles() {
        if (this.level().isClientSide()) {
            ...
            for (int i = 0; i < 15; i++) {
                ...
                // 红色粒子效果
                Vector3f color = new Vector3f(1.0f, 0.2f, 0.1f); // 红色
    ...
    private void spawnFlightParticles() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            // 红色粒子效果
            Vector3f color = new Vector3f(1.0f, 0.1f, 0.05f); // 深红色
